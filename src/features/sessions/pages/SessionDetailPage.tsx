...
import { formatStr, getStateTone, safeDateFormat } from '../../../lib/utils'
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={`${safeDateFormat(session.date, 'EEEE, MMM d, yyyy', { locale: getDateLocale(i18n.language) })} · ${session.startTime}–${session.endTime} · ${displayNote}`}
