...
interface MusicIconProps extends SVGProps<SVGSVGElement> {
  size?: number
}

/**
 * Vector icon for Music / 音乐 task type (replaces 🎵 emoji).
 * Source: 音乐.svg
 */
export function MusicIcon({ size = 24, className, ...props }: MusicIconProps) {
  return (
    <svg
