...
import { cn, formatStr, getScoreTone, getStrNarrativeKey, getToneClasses, safeFormat } from '../../lib/utils'
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-slate-500 md:text-sm">
                {safeFormat(session.date, 'MMM d, yyyy', getDateLocale(i18n.language))} · {session.startTime}-{session.endTime}
              </p>
